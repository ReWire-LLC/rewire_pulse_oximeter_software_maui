...
{
    public class Page_DetailedView_ViewModel : NotifyPropertyChangedObject
    {
        ...
        public Page_DetailedView_ViewModel()
        {
        ...
        #region Handle property changes from the model
        ...
        #region Plot initialization methods
